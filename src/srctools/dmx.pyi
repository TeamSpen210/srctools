...
@overload
def deduce_type(value: list[Value]) -> tuple[ValueType, list[Value]]: ...
@overload
def deduce_type(value: Value) -> tuple[ValueType, Value]: ...

def deduce_type_array(value: list[Value]) -> tuple[ValueType, list[Value]]: ...
def deduce_type_single(value: Value) -> tuple[ValueType, Value]: ...
...
class Attribute(Generic[ValueT], _ValProps):
    ...
    def __iter__(self) -> Iterator[ValueT]: ...  # deprecated

    def append(self, value: Value) -> None: ...
    def extend(self, values: Iterable[Value]): ...
