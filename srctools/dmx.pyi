...
class Element(Mapping[str, Attribute]):
    ...
    def __setitem__(self, name: str, value: Attribute | Value) -> None: ...
    ...
    @overload
    def pop(self, name: str, default: Attribute | Value = ...) -> Attribute: ...
    def popitem(self) -> tuple[str, Attribute]: ...
    def setdefault(self, name: str, default: Attribute | Value) -> Attribute: ...

    @overload
    def update(self, mapping: Mapping[str, Attribute], /, **kwargs: Attribute | Value) -> None: ...
    @overload
    def update(self, iterable: Iterable[tuple[str, ValueT] | Attribute], /, **kwargs: Attribute | Value) -> None: ...
    @overload
    def update(self, /, **kwargs: Attribute | Value) -> None: ...
