...
from typing import (
    ...
    Callable, IO, Mapping, Optional, overload, Iterator,
)
...
class Attribute(Generic[ValueT], _ValProps):
    ...
    @overload
    def __init__(self: Attribute[Optional[Element]], name: str, val_type: Literal[ValueType.ELEMENT], value: Union[Optional[Element], list[Optional[Element]]]) -> None: ...
    @overload
    ...
    @classmethod
    @overload
    def array(cls, name: str, val_type: Literal[ValueType.ELEMENT]) -> Attribute[Optional[Element]]: ...
    @classmethod
    @overload
    ...
    def __setitem__(self, item: Union[builtins.int, slice], value: ValueT) -> None: ...
...
class Element(Mapping[str, Attribute]):
    ...
    def __setitem__(self, name: str, value: Union[Attribute, Value]) -> None: ...
    ...
    @overload
    def pop(self, name: str, default: Union[Attribute, Value] = ...) -> Attribute: ...
    def popitem(self) -> tuple[str, Attribute]: ...
    def setdefault(self, name: str, default: Union[Attribute, Value]) -> Attribute: ...

    @overload
    def update(self, mapping: Mapping[str, Attribute], /, **kwargs: Union[Attribute, Value]) -> None: ...
    @overload
    def update(self, iterable: Iterable[Union[tuple[str, ValueT], Attribute]], /, **kwargs: Union[Attribute, Value]) -> None: ...
    @overload
    def update(self, /, **kwargs: Union[Attribute, Value]) -> None: ...
